...
const AIWorkflow = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      eventSourceRef.current = new EventSource(
        `${API_BASE_URL}/api/ai/generate-complete`,
        {
          method: "POST",
          headers: {
  ...
  const handleProgressUpdate = (data) => {
    ...
    if (data.complete) {
      ...
      console.log(
        "Current generatedFiles state before update:",
        generatedFiles
      );
      ...
      if (data.files && Array.isArray(data.files)) {
        ...
        console.warn(
          "No files found in complete data or files is not an array"
        );
        console.log(
          "data.files type:",
          typeof data.files,
      ...
      setLogs((prev) => [
        ...prev,
        {
          type: "success",
          agent: "SYSTEM",
          message: `✅ Pipeline completed! Generated ${
            data.files?.length || 0
          } files in ${data.processingTime}s`,
          timestamp: data.timestamp,
        },
      ]);
      ...
      <div className="max-w-7xl mx-auto">
              ...
              >
                {isProcessing || mockLoading ? (
                  <>
                    ...
                    <span>
                      {mockLoading ? "Mock Demo..." : "Processing..."}
                    </span>
                  </>
                ) : (
                  <>
          ...
          <div className="bg-gray-900 border border-green-600 rounded-lg p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xl font-semibold text-green-300">
                ...
                {mockLoading && (
                  <span className="ml-2 text-purple-400">(Mock Demo)</span>
                )}
              </h3>
              {timeEstimate && (
              ...
              <div className="mb-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-white font-semibold">
                    {mockAgents[currentMockAgent]?.icon}{" "}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-900 border border-green-600 rounded-lg">
            <div className="bg-green-600 text-black px-4 py-2 rounded-t-lg font-semibold flex items-center justify-between">
              ...
              {generatedFiles.length > 0 && (
                <span className="text-sm">
                  {generatedFiles.length} files • {processingTime}s • Room:{" "}
                  {roomId.slice(-8)}
                </span>
              )}
            </div>
            ...
            {(() => {
              console.log(
                "Rendering files section. generatedFiles.length:",
