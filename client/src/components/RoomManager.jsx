...
const RoomManager = ({ onCreateRoom, onJoinRoom, user, onUserChange }) => {
  ...
  return (
    <>
      ...
      {notification && (
        <div className="fixed top-4 right-4 z-50 bg-black border border-green-400 p-4 min-w-80" style={{ fontFamily: "'Courier New', Consolas, Monaco, monospace" }}>
          <div className={`text-sm ${
            ...
            <div className="flex items-center gap-2 mb-1">
              <span className="text-green-400/60">[SYSTEM]</span>
              <span className={
                notification.type === 'success' ? 'text-green-400' :
                notification.type === 'error' ? 'text-red-400' :
                'text-green-400/80'
