...
function Dashboard() {
  ...
  const [recentRooms] = useState([
    { id: "room_abc123", name: "auth_vulnerability_fix", status: "active", participants: 2, created: "14:32" },
    { id: "room_def456", name: "api_security_audit", status: "idle", participants: 1, created: "13:47" },
    { id: "room_ghi789", name: "db_migration_secure", status: "completed", participants: 3, created: "12:15" },
  ]);
  ...
  const getRealSystemInfo = () => {
    const specs = {
      ...
      userAgent: navigator.userAgent.split(' ').slice(0, 3).join(' ') || 'Unknown'
    };
...
Scan complete: No critical vulnerabilities found`;
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono overflow-hidden" style={{ fontFamily: "'Courier New', Consolas, Monaco, 'Advercase', monospace" }}>
      {/* Terminal Header */}
        ...
        <div className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-green-400 text-sm">OVERLOOK_TERMINAL_v2.1.3</span>
            </div>
        ...
        <div className="w-80 border-r border-green-400/30 bg-black/50 p-4 flex flex-col">
              ...
              {recentRooms.map((room) => (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div className={`flex items-center gap-1 ${getStatusColor(room.status)}`}>
          ...
          <div className="flex-1 border border-green-400/30 bg-green-400/5 flex flex-col">
            <div className="flex items-center gap-2 p-2 border-b border-green-400/20">
              ...
              <div className="ml-auto text-green-400/60 text-xs">overlook@system:~$</div>
            </div>
            
            {/* Terminal History - Expanded */}
            <div className="flex-1 overflow-y-auto p-3 text-xs text-green-400/80 space-y-1 font-mono" style={{ fontFamily: "'Courier New', Consolas, Monaco, monospace" }}>
              {terminalHistory.map((entry, index) => (
                <div key={index} className={entry.type === 'input' ? 'text-green-400' : 'text-green-400/60'}>
                  {entry.content.split('\n').map((line, lineIndex) => (
            ...
            <div className="px-3 pb-2 text-xs text-green-400/40 border-t border-green-400/10">
              Commands: help | create | join [id] | list | status | scan [url] | clear
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col">
            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <div className="mb-8">
                ...
                <p className="text-green-400/60 text-sm">
                  Initialize secure coding environments with real-time vulnerability detection
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="border border-green-400/30 bg-green-400/5 p-6 hover:border-green-400/50 hover:bg-green-400/10 transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-green-400 text-lg">CREATE_NEW_SESSION</h3>
                  </div>
                  
                  <p className="text-green-400/60 text-sm mb-6 leading-relaxed">
                    Initialize a new secure collaborative environment with AI-powered 
                    security validation and real-time code analysis.
                  </p>
                ...
                <div className="border border-green-400/30 bg-green-400/5 p-6 hover:border-green-400/50 hover:bg-green-400/10 transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-green-400 text-lg">JOIN_EXISTING_SESSION</h3>
                  </div>
                  
                  <p className="text-green-400/60 text-sm mb-6 leading-relaxed">
                    Connect to an active collaboration session using the session identifier.
                  </p>
                ...
                <div className="border border-red-400/30 bg-red-400/5 p-6 hover:border-red-400/50 hover:bg-red-400/10 transition-all">
                  ...
                  <p className="text-red-400/60 text-sm mb-6 leading-relaxed">
                    Simulate various attack vectors against your applications to identify vulnerabilities.
                  </p>
          ...
          <div className="border-t border-green-400/30 bg-black p-4 relative overflow-hidden">
            <div className="flex items-center gap-2 mb-3 text-xs">
              ...
              <div className="ml-auto text-green-400/60 text-xs font-mono" style={{ fontFamily: "'Courier New', Consolas, Monaco, monospace" }}>
                {currentTime.toLocaleTimeString('en-US', { hour12: false })}
              </div>
            </div>
            ...
            <div className="relative h-32 bg-black/50 border border-green-400/20 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center font-mono" style={{ fontFamily: "'Courier New', Consolas, Monaco, monospace" }}>
                  <div className="text-green-400 text-sm mb-2">OVERLOOK_SYSTEM_MONITOR</div>
                  <div className="grid grid-cols-2 gap-2 text-xs text-green-400/80">
                    <div>PLATFORM: {systemSpecs.platform.split(' ')[0] || 'Unknown'}</div>
            ...
            <div className="mt-2 text-xs text-green-400/40 text-center font-mono" style={{ fontFamily: "'Courier New', Consolas, Monaco, monospace" }}>
