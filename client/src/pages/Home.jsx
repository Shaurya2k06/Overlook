      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && !pipelineAutoStarted) {
            ...
            animateNumber(
              0,
              securityInsights.codeLinesScanned,
              2500,
              setDisplayedLinesScanned
            );
          }
        });
      },
  ...
  useEffect(() => {
    ...
    const insightsInterval = setInterval(() => {
      setSecurityInsights((prev) => ({
        ...
        codeLinesScanned:
          prev.codeLinesScanned + Math.floor(Math.random() * 50) + 10,
        vulnerabilitiesFixed:
          prev.vulnerabilitiesFixed + (Math.random() > 0.7 ? 1 : 0),
...
function login(email, password) {
  ...
  return (
    <div className="scroll-container">
      ...
      >
        ...
        <div className="container mx-auto px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              <h1
                className="text-6xl sm:text-7xl lg:text-8xl font-light tracking-tight mb-12 leading-tight"
                style={{ fontFamily: "Advercase, monospace" }}
              >
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-16">
                The first AI code generation platform with built-in security
                validation.
                <span className="text-[#00EFA6]">
                  {" "}
                  Reduce vulnerabilities by 80%+
                </span>{" "}
                through real-time multi-agent security analysis.
              </p>
      ...
      <section
        id="pipeline"
        className="snap-section relative pt-24 pb-4 bg-black border-t border-white/10 text-white"
        ref={pipelineRef}
      >
        <video
          autoPlay
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10 h-full flex flex-col justify-center">
          ...
          <div className="mb-2">
            <h2
              className="text-2xl font-light mb-1 text-white"
              style={{ fontFamily: "Advercase, monospace" }}
            >
              Security Pipeline
            </h2>
            <p className="text-gray-400 text-xs">
              Multi-agent code security analysis and remediation
            </p>
          </div>
                  ...
                  {agents.map((agent, idx) => {
                    ...
                    return (
                      <div key={idx} className="text-center">
                        <div
                          className={`w-12 h-12 mx-auto mb-2 border-2 flex items-center justify-center transition-all duration-500 ${
                            isActive
                        ...
                        {isActive && (
                          <div className="mt-1 w-full h-0.5 bg-white/20">
                            <div
                              className="h-full bg-white transition-all duration-300 animate-pulse"
                              style={{ width: "60%" }}
                            />
                          </div>
                        )}
                ...
                <div className="p-3 space-y-2">
                  ...
                  <div className="w-full h-1.5 bg-white/10">
                    <div
                      ...
                      style={{ width: `${displayedSecurityScore}%` }}
                    />
                  </div>
                  ...
                  <div className="pt-2 border-t border-white/10">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="text-blue-400 font-mono">
                        {displayedLinesScanned.toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-2 border-b border-white/20">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs text-gray-500 font-mono">
                      STEP {currentStep + 1}/4 | AGENT:{" "}
                      {agents[activeAgent].name.toUpperCase()}
                    </div>
                  </div>
                </div>
                <div className="p-3">
                  <div className="font-mono text-xs space-y-0.5 text-gray-300 h-32 overflow-y-auto">
                    <div className="text-gray-500">
                      $ overlook-security --scan --realtime --verbose
                    </div>
                    <div className="text-gray-400">
                      Initializing security pipeline...
                    </div>
                    <div className="text-gray-400">
                      Loading security modules: [Semgrep, ESLint, Custom Rules]
                    </div>
                    <div className="text-white">
                      Pipeline ready. Starting agent workflow...
                    </div>
                    ...
                    {isProcessing && (
                      <>
                        <div className="text-white">
                          🔄 Running: {agents[activeAgent].name}
                        </div>
                        <div className="text-gray-400">
                          Task: {agents[activeAgent].task}
                        </div>
                        ...
                        {activeAgent === 0 && (
                          <>
                            <div className="text-blue-400">
                              $ ai-generator --model=gpt-4 --security-mode
                            </div>
                            <div className="text-gray-400">
                        ...
                        {activeAgent === 1 && (
                          <>
                            <div className="text-blue-400">
                              $ debug-agent --trace --memory-check
                            </div>
                            <div className="text-gray-400">
                              Analyzing code flow...
                            </div>
                        ...
                        {activeAgent === 2 && (
                          <>
                            <div className="text-amber-400">
                              $ semgrep --config=security --sarif-output
                            </div>
                            <div className="text-gray-400">
                              Scanning for OWASP Top 10...
                            </div>
                            <div className="text-gray-400">
                              Running 247 security rules...
                            </div>
                            {vulnerabilitiesFound > 0 && (
                              <>
                                <div className="text-red-400">
                                  ⚠️ {vulnerabilitiesFound} vulnerabilities
                                  detected!
                                </div>
                                {codeSteps[currentStep].vulnerabilities.map(
                                  (vuln, idx) => (
                        ...
                        {activeAgent === 3 && (
                          <>
                            <div className="text-red-400">
                              $ red-team-agent --aggressive --exploit-mode
                            </div>
                            <div className="text-red-400">
                              🔴 INITIATING PENETRATION TESTING...
                            </div>
                            <div className="text-red-400">
                              $ sqlmap -u target --batch --level=5 --risk=3
                            </div>
                            <div className="text-red-400">
                              $ nikto -h target -C all -evasion 1234567890AB
                            </div>
                            <div className="text-red-400">
                            ...
                            <div className="text-red-400">
                              $ burpsuite --scan --active-scan target
                            </div>
                            <div className="text-red-400">
                              $ zap-baseline.py -t target -J report.json
                            </div>
                            <div className="text-red-400">
                              $ wfuzz -c -z file,payloads.txt target/FUZZ
                            </div>
                            <div className="text-red-400">
                            ...
                            <div className="text-red-400">
                              $ ffuf -w wordlist.txt -u target/FUZZ -mc
                              200,301,302
                            </div>
                            ...
                            <div className="text-yellow-400">
                              🛡️ Attempting exploit mitigation...
                            </div>
                    ...
                    {!isProcessing && hasPlayedOnce && (
                      <>
                        ...
                        <div className="text-gray-400">
                          All security agents finished successfully.
                        </div>
                        <div className="text-gray-400">
        ...
        <div className="container mx-auto px-8 max-w-5xl relative z-10">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Traditional AI code generators create vulnerable systems
            </p>
          </div>
              ...
              <div className="border border-white/20 bg-black/50">
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="border-l-2 border-white/30 pl-4">
                    ...
                    <div className="text-xs text-gray-400">
                      ANNUAL COST OF SECURITY BREACHES
                    </div>
                  </div>
                  <div className="border-l-2 border-white/30 pl-4">
                    <div className="text-2xl font-mono text-white">2.3x</div>
                    <div className="text-xs text-gray-400">
                      INCREASE IN AI CODE VULNERABILITIES
                    </div>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div className="container mx-auto px-8 max-w-5xl relative z-10">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Multi-agent security architecture with real-time validation
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="border border-white/20 bg-black/50 p-4">
              <div className="mb-3">
                ...
                <div className="text-xs text-gray-400">
                  Every line analyzed using Semgrep and custom patterns
                </div>
              </div>
            ...
            <div className="border border-white/20 bg-black/50 p-4">
              <div className="mb-3">
                ...
                <div className="text-xs text-gray-400">
                  Adversarial agents actively exploit code vulnerabilities
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
            ...
            <div className="border border-white/20 bg-black/50 p-4">
              <div className="mb-3">
                ...
                <div className="text-xs text-gray-400">
                  Automatic generation of secure code alternatives
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                ...
                {[
                  {
                    step: "01",
                    name: "CODE INPUT",
                    desc: "User provides prompt or code",
                  },
                  {
                    step: "02",
                    name: "AI GENERATION",
                    desc: "Multiple models generate solutions",
                  },
                  {
                    step: "03",
                    name: "SECURITY SCAN",
                    desc: "Real-time vulnerability detection",
                  },
                  {
                    step: "04",
                    name: "SECURE OUTPUT",
                    desc: "Validated, patched code delivery",
                  },
                ].map((item, idx) => (
                  <div key={idx} className="text-center">
      ...
      >
        ...
        <div className="container mx-auto px-8 max-w-5xl relative z-10">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              AI models and security tools integrated into Overlook
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="border border-white/20 bg-black/50">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 text-xs">LLAMA 70B</span>
                  <span className="text-white text-xs">SECURITY ANALYSIS</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400 text-xs">MISTRAL-MEDIUM</span>
      ...
      >
        ...
        <div className="container mx-auto px-8 max-w-5xl relative z-10">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Measurable security improvements with Overlook
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="border border-white/20 bg-black/50 p-4">
              ...
              <div className="text-xs text-gray-400">
                Compared to standard AI generation
              </div>
            </div>
          ...
          <div className="border border-white/20 bg-black/80 p-6 text-center">
            <div className="mb-4">
              ...
              <p className="text-gray-400 text-sm">
                Join the future of AI-powered development with built-in security
                validation.
              </p>
            </div>
      ...
      <footer className="relative border-t border-white/10 py-8 bg-black">
        ...
        <div className="container mx-auto px-8 max-w-5xl relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
            <div style={{ fontFamily: "Advercase, monospace" }}>
