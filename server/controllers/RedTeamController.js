// redTeamController.js
const { execSync } = require("child_process");
const path = require("path");
const fs = require("fs");
const axios = require("axios");
const runCustomExploit = require("../middleware/red_team_exploits"); // Should be in same folder or adjust path
...
async function performSecurityAudit(
  ...
  let semgrepReport;
  try {
    semgrepPath = "/home/quagza/Desktop/venv/bin/semgrep";
